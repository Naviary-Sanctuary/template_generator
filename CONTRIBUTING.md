# Contributing to `template generator`

Thank you for showing interest in `template generator` and we appreciate any contribution.
...
You can submit issues with [our issue form](https://github.com/Naviary-Sanctuary/template_generator/issues/new/choose)
